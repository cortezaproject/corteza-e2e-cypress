<h1 align="center">
  ...
  <br />
  <p>Corteza Cypress Testing</p>

  <div align="center">

  [![License Card](https://img.shields.io/github/license/cortezaproject/corteza-e2e-cypress)](https://img.shields.io/github/license/cortezaproject/corteza-e2e-cypress)
...
**Corteza e2e cypress** is an application build for testing **Corteza's** functionalities. Its tests can be run one by one or by using the predefined index files. 

Refer to the [Cypress docs](https://docs.cypress.io/guides/overview/why-cypress) for more details.
