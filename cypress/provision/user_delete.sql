...
delete from role_members where rel_resource = 'corteza::system:user/368979993402802177';
...
delete from role_members where rel_resource = (select concat('corteza::system:user/', id) from users where email = 'cypress@test.com');
