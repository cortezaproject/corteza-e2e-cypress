...
describe("Test helper dropdown functionalities", () => {
  context("Test for logging in the user", () => {
    it("should be able to log in successfully", () => {
      cy.visit(baseURL + "/"); // Localhost in the env file should be changed to reflect the Compose host. We are visiting the main authentication page here.
      ...
      cy.visit(baseURL + "/compose/namespaces"); // Visiting main page of Compose
    });
  });
