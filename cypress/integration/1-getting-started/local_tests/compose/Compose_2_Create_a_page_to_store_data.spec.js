...
it("Log in and access the already created NS", () => {
  ...
  cy.get('[href="/compose/ns/>>HANDLE<</pages"]').click(); // Here we use the handle (after /ns/) from the created NS (When testing things locally compose part should be removed)
});
