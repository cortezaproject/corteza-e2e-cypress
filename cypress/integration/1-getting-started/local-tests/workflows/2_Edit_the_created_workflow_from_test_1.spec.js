...
describe("Test for editing a workflow", () => {
  ...
  context("Test for editing a workflow", () => {
    it("should be able to edit the workflow", () => {
      ...
      cy.get('[data-test-id="input-label"]').type(" edited"); // We edit the name of the workflow
      cy.get('[data-test-id="input-handle"]').type("_edited"); // We edit the handle of the workflow
      cy.get('[data-test-id="input-description"]').type(" And this description just got edited."); // We edit the description of the workflow
      ...
      cy.get(".close").click(); // We close the configuration modal
    });
  });
});
